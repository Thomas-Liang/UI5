sap.ui.define([
	...
	return Controller.extend("sap.ui.core.tutorial.odatav4.controller.App", {
		...
		onInit: function() {
			...
			oMessageModelBinding.attachChange(this.onMessageBidingChange, this);
		...
		onInputChange: function(oEvt) {
			if (oEvt.getParameter("escPressed")) {
				...
				if (oEvt.getSource().getBindingContext().getProperty("UserName")) {
		...
		onSort: function() {
			var oView = this.getView(),
				...
				aStateTextIds = ["sortNone", "sortAscending", "Descending"],
				sMessage,
